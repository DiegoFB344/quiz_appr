...
export const Question = ({
  ...
  return (
    ...
    {activeResults ? (
        ...
        <Results questionsFiltered={questionsFiltered}
        score={score}
        onReset={onReset} />
    ) : (
          <div
          className="flex flex-col justify-between shadow-md shadow-slate-300 w-[600px] h-[600px] p-10 
          rounded-lg"
        >
          ...
          <div className="grid grid-cols-2 gap-5">
            {/** mapeamos un arreglo de respuestas y respuestas incorrectas */}
            {
          ...
          {/** condicional p ara mostrar el boton de seguiente pregunta al finalizar */}
